...
class NavBar extends React.Component {constructor(...args) {super(...args);_defineProperty(this, "state",
    {
      content: [
        { id: 1, description: "<iframe src='https://docs.google.com/presentation/d/e/2PACX-1vQk7pm5KJzdmnDjD_Sb0xazdp4C3JqxcvlQK20E7_ysn_aeJCOqgMPSNFRXGKbxjz3s0sHC2duVUPq_/embed?start=false&loop=false&delayms=3000' frameborder='0' width='1440' height='839' allowfullscreen='true' mozallowfullscreen='true' webkitallowfullscreen='true'></iframe>" },
