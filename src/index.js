...
class NavBar extends React.Component {constructor(...args) {super(...args);_defineProperty(this, "state",
    {
      content: [
        { id: 1, description: "<iframe src='https://docs.google.com/presentation/d/e/2PACX-1vR9OrLyWwApUbFF8Yf-UVVQgOC6rN6gl_LlNM9Uujs42epAvMyU5KDQT1OzSxRn2g3hElCKWYZGOSfL/embed?start=false&loop=false&delayms=60000' frameborder='0' width='1440' height='839' allowfullscreen='true' mozallowfullscreen='true' webkitallowfullscreen='true'></iframe>" },
